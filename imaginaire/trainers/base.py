...
class BaseTrainer(object):
    ...
    def set_data_loader(self, cfg, split, shuffle=True, drop_last=True, seed=0, subset_indices=None):
        ...
        if split == "train":
            ...
            self.eval_data_loader = get_val_dataloader(cfg, seed=seed, subset_indices=subset_indices)
        elif split == "test":
